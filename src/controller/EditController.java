...
public class EditController implements ActionListener {
	...
	public EditController(ListView listView, TaskSettingView settingView,
	...
	public void actionPerformed(ActionEvent e) {
		if (e.getSource() instanceof JButton) {
			...
			// DisplayTaskPanel panel = (DisplayTaskPanel)((JButton)
			...
			if (e.getActionCommand().equals("cancel")) {
				...
				// Updates the deadlinelabel in edittaskpanel before saving to
				// all panels
				if (editTaskPanel.getCalendar().isOkPressed()) {
					editTaskPanel.deadlineLabel.setText(editTaskPanel
							.getJDateTextField());
				}
	...
	private void toDisplayTask() {
		...
		displayTaskPanel = new DisplayTaskPanel(model,
				editTaskPanel.getTaskModel());
		displayController = new DisplayController(listView, settingView,
				displayTaskPanel);
